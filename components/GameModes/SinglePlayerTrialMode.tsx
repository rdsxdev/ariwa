            ...
            >
              <div className="flex justify-center items-center flex-col gap-6 w-full min-w-84">
                ...
                <motion.button
                  ...
                  onClick={callEndgame}
                  className="flex gap-3 text-sm bg-incorrect p-3 w-full rounded-lg text-center justify-center items-center hover:opacity-70   --shadow-inner--  shadow-foreground/50"
                >
            ...
            >
              <div className="flex justify-center items-center flex-col gap-6 w-full min-w-84">
                ...
                <div className="flex justify-center items-center flex-col">
                  ...
                  <div className="text-sm">
                    You played well, your score was:
                  </div>
                </div>
                ...
                <motion.button
                  ...
                  onClick={callEndgame}
                  className="flex gap-3 text-sm bg-correct text-background p-3 w-full rounded-lg text-center justify-center items-center hover:opacity-70 "
                >
              ...
              <div className="absolute -left-36 top-0 text-white py-2 flex flex-col -items-end gap-3 max-md:relative max-md:flex-row max-md:left-auto max-md:justify-end max-md:w-full max-md:px-3 ">
                {gameover && !win && !lose && (
                  <motion.button
                    ...
                    onClick={callEndgame}
                    className="bg-correct/70 text-white p-3 rounded-lg border  border-correct flex gap-3 text-sm items-center  --shadow-inner--  shadow-correct/50"
                  >
